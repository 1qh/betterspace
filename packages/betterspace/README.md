...
| [Recipes](docs/recipes.md)                   | 17 real-world composition patterns: chat, file upload, org+ACL, caching, soft delete, mutation workflows, typed components, global error types, schemaVariants, field validation, useMutation, toast shorthand, field error toasts, phantom types, error discrimination, bulk operations, ownership flags |
