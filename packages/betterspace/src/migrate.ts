...
Examples:
  betterspace migrate                    Compare HEAD vs working tree
  betterspace migrate --from HEAD~3      Compare 3 commits ago vs now
  betterspace migrate --snapshot         Print current schema tables & fields
`)
      return
    }
