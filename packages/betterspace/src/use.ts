...
const TARGETS: Record<Target, { label: string; server: string; uri: string }> = {
  ...
  printUseHelp = () => {
    console.log(`${bold('betterspace use')} — switch SpacetimeDB target\n`)
    console.log(bold('Usage:'))
    console.log('  betterspace use <target>\n')
    ...
    console.log(`  ${dim('$')} betterspace use local`)
    console.log(`  ${dim('$')} betterspace use cloud\n`)
  },
