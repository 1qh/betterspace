...
`,
  ...
  printGenerateHelp = () => {
    console.log(`${bold('betterspace generate')} — generate project files\n`)
    console.log(bold('Usage:'))
    console.log('  betterspace generate <target> [options]\n')
    ...
    console.log(`  ${dim('$')} betterspace generate docker`)
    console.log(`  ${dim('$')} betterspace generate docker --stdout`)
    console.log(`  ${dim('$')} betterspace generate docker --force\n`)
  },
  generate = (args: string[] = []) => {
    ...
    console.log(`  ${dim('2.')} betterspace use local`)
