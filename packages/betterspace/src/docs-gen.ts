...
const dim = (s: string) => `\u001B[2m${s}\u001B[0m`,
  ...
  ENTRY_POINTS: { label: string; path: string }[] = [
    { label: 'betterspace', path: 'index.ts' },
    { label: 'betterspace/schema', path: 'schema.ts' },
    { label: 'betterspace/react', path: 'react/index.ts' },
    { label: 'betterspace/server', path: 'server/index.ts' },
    { label: 'betterspace/components', path: 'components/index.ts' },
    { label: 'betterspace/next', path: 'next/index.ts' },
    { label: 'betterspace/zod', path: 'zod.ts' },
    { label: 'betterspace/seed', path: 'seed.ts' },
    { label: 'betterspace/retry', path: 'retry.ts' },
    { label: 'betterspace/eslint', path: 'eslint.ts' },
    { label: 'betterspace/test', path: 'server/test.ts' }
  ],
