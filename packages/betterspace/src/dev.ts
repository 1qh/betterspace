...
const green = (s: string) => `\u001B[32m${s}\u001B[0m`,
  ...
  printDevHelp = () => {
    console.log(`${bold('betterspace dev')} — integrated SpacetimeDB + Next.js development\n`)
    console.log(bold('Usage:'))
    console.log('  betterspace dev [options]\n')
  ...
  dev = async (args: string[] = []) => {
    ...
    console.log(`\n${bold('betterspace dev')} ${dim('— starting development environment')}`)
