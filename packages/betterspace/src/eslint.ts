...
/** Map of all ESLint rules provided by the betterspace plugin. */
const rules = {
...
/** ESLint plugin object containing all betterspace rules. */
const plugin = { rules }

/** Recommended ESLint configuration for betterspace projects. */
const recommended = {
  files: ['**/*.ts', '**/*.tsx'],
  plugins: {
    betterspace: plugin
  ...
  rules: {
    'betterspace/api-casing': 'error' as const,
    'betterspace/consistent-crud-naming': 'error' as const,
    'betterspace/discovery-check': 'warn' as const,
    'betterspace/form-field-exists': 'error' as const,
    'betterspace/form-field-kind': 'warn' as const,
    'betterspace/no-duplicate-crud': 'error' as const,
    'betterspace/no-empty-search-config': 'error' as const,
    'betterspace/no-raw-fetch-in-server-component': 'warn' as const,
    'betterspace/no-unlimited-file-size': 'warn' as const,
    'betterspace/no-unprotected-mutation': 'warn' as const,
    'betterspace/no-unsafe-api-cast': 'warn' as const,
    'betterspace/prefer-useList': 'warn' as const,
    'betterspace/prefer-useOrgQuery': 'warn' as const,
    'betterspace/require-connection': 'error' as const,
    'betterspace/require-error-boundary': 'warn' as const,
    'betterspace/require-rate-limit': 'warn' as const
  }
}
